...
const UpdatedUser = createRouteTab(
  () => {
    const options = [
      { key: 1, text: 'Analista', value: 1 },
      { key: 2, text: 'Recrutador', value: 2 },
      { key: 3, text: 'Adminstrador', value: 3 },
    ]
    ...
    return (
      <Container hasDisable={isDisable}>
        <ContainerHeader>
        ...
        <LastUpdated>
          <p> Útima modificacão realizada</p>
          <p> Terça-Feira 09/03/2021- 10:30:20 - Por 224156- Eudes Martins</p>
        </LastUpdated>
      </Container>
    )
  },
