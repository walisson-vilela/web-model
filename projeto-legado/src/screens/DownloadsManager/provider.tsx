...
export const DownloadsManagerProvider: RouteTabProvider = (props) => {
...
const useDownloadsManagerContext = () => useContext(Context)

export default useDownloadsManagerContext
