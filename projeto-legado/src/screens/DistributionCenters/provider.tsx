...
export const DistributionCentersProvider: RouteTabProvider = (props) => {
...
const useDistributionCentersContext = () => useContext(Context)

export default useDistributionCentersContext
