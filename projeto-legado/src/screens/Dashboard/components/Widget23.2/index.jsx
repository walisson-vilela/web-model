...
import { Widget232Failure, Widget232Request, Widget232Sucess } from '../../../../redux/actions/WidgetAction';
 ...
 const options ={
    ...
    useEffect(() =>{
        async function loadData(){
            dispatch(Widget232Request())
            try{
                dispatch(Widget232Failure())
