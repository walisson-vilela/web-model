...
export const Widget26 = ({ segment_id }) => {
  const dispatch = useDispatch()
  const loading = useSelector((state: any) => state.w26.loading)
  const data = useSelector((state: any) => state.w26.data)
  ...
  return (
    <>
      <TreeMap
        header={{
          text: 'Top 20 - Tipologia (S0)',
          expand: true,
          link: '/main/dashboard/home/top-typology',
        }}
        loading={loading}
        options={options}
        onOpen={setOpen}
