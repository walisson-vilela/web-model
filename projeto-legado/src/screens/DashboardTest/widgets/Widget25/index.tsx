...
export const Widget25 = ({ segment_id }) => {
  const dispatch = useDispatch()
  const loading = useSelector((state: any) => state.w25.loading)
  const data = useSelector((state: any) => state.w25.data)
  ...
  return (
    <>
      <TreeMap
        header={{
          text: 'Top 20-Canal(S0)',
          expand: true,
          link: '/main/dashboard/home/segmentation',
        }}
        loading={loading}
        options={options}
        onOpen={setOpen}
