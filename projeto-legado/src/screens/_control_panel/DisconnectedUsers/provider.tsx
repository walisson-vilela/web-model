...
export const DisconnectedUsersProvider: RouteTabProvider = (props) => {
...
const useDisconnectedUsersContext = () => useContext(Context)

export default useDisconnectedUsersContext
