...
export const PredictedAttendancesProvider: RouteTabProvider = (props) => {
...
const usePredictedAttendancesContext = () => useContext(Context)

export default usePredictedAttendancesContext
