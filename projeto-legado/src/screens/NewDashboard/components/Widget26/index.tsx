...
export function Widget26({ setOpen, onHandleOptions, segment_id }) {
  const dispatch = useDispatch()
  const { widget26 } = useSelector((state: any) => state.dashboard)
  const { loading, data } = widget26
        ...
        <>
          <Container>
            <div className='header'>
              <strong> Top 20 - Canal (S0)</strong>
              <div className='hide-on-print wrapper'>
                <Link to='/main/dashboard/home/segmentation'>
