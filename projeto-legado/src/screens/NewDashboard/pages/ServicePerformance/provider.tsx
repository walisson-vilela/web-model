...
export const ServicePerformanceProvider: RouteTabProvider = (props) => {
...
const useServicePerformanceContext = () => useContext(Context)

export default useServicePerformanceContext
