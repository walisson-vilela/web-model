...
import { ManagerProps as DefaultManagerProps, UseState } from '../../interfaces'
...
import { getFiles as request } from './services'

interface ManagerProps extends DefaultManagerProps {
  formType: FormStateInterface['type']
  reloadTriggerState: UseState<boolean>
}

const Manager = (props: ManagerProps) => {
  const [reloadTrigger, setReloadTrigger] = props.reloadTriggerState
  ...
  const loadData = useCallback(async () => {
    ...
    setLoading(false)
  }, [appliedFilters, search, sort, page, props.formType])
