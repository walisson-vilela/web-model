...
export const Card21DetailProvider: RouteTabProvider = (props) => {
...
const useCard21DetailContext = () => useContext(Context)

export default useCard21DetailContext
