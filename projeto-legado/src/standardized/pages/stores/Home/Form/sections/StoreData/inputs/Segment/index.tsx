...
type SegmentType = Exclude<Form['segment'], null>

const parser: ParserFunction<SegmentType> = (data) => {
  return data.reduce<SelectOption<SegmentType>[]>((parsed, e) => {
    ...
    const option: SelectOption<SegmentType> = {
      label: name,
      data: { id, name },
      value: id.toString(),
    }
      ...
      <Controller
        ...
        render={({ field: props }) => {
          ...
          const initialLoader = useCallback((): SelectOption[] => {
            return originals.segment
              ? [
                  {
                    label: originals.segment.name,
                    data: originals.segment,
                    value: originals.segment.id.toString(),
                  },
                ]
              : []
          }, [originals])
          ...
          return (
            <MwInput
              ...
              setValue={(id, value) => {
                const v = id ? (value as SegmentType) : null
