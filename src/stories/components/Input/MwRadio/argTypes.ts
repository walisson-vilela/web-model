...
import type { RadioButtonProps } from '../../../../components/Input/components/RadioButton/interfaces'

const argTypes: Partial<ArgTypes<RadioButtonProps>> = {
  name: {
    description: 'required prop to register the input ',
    table: {
  ...
  checked: {
    description: 'Define if the button is checked.',
    table: {
      defaultValue: { summary: 'false' },
    },
    control: 'boolean',
